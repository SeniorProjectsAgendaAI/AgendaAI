...
allowed_origins_str = os.getenv("ALLOWED_FRONTEND_URLS", default_origins)
...
app.add_middleware(
    ...
    allow_origin_regex=r"^http://localhost:3000$|^https://[a-zA-Z0-9-]+\.d2i3jqbsdy4snq\.amplifyapp\.com$",
